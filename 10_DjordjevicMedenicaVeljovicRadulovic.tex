...
\abstract{ U ovom radu ćemo opisati razvoj kompanije IBM kroz istoriju, pa sve do danas. Videćemo kako je uz pomoć svoje hrabrosti i inovativnosti došla do pozicije najpoznatije i vodeće firme na tržistu i tu poziciju dugo održavala, ali i njen pad i kako danas izgleda.}
\tableofcontents
...
a svoj domet uveliko je proširila i na ostatak sveta. Zarada kompanije se uvećala čak pet puta i iznosila je 7,5 milijardi dolara, dok se broj zaposlenih više nego duplirao i iznosio je preko 250 hiljada. %TODO 
...
Pored ovoga, IBM je razvio i brzu memoriju sa jednoćelijskim tranzistorima danas poznatiju kao DRAM (eng.~{\em Dynamic Random Access Memory})\cite{timeline}.%eng?
\\ \\
